...
export PATH=/home/petya/.cabal/bin:$PATH

#My Perl scripts
export gouda="/home/petya/Scripts/gouda.pl"
export PATH=$PATH:$gouda

#My sync doc script
export syncdocs=/home/petya/Scripts/sync2.sh
export PATH=$PATH:$syncdocs

#export bsync=/home/petya/Scripts/bsync.py
#export PATH=$PATH:$bsync

# Zenity test for colorpicker
export colorpicker=/home/petya/Scripts/color_dialog.sh
...
alias mkvirtualenv2='mkvirtualenv -p /usr/bin/python2.7 --no-site-packages'
...
alias glue='/home/petya/Snakepit/glue_sprites/bin/glue'
...
#if [ -n "$SSH_CONNECTION" ]; then text="ssh"
#export PS1=' \[\e[1;33m\]\u@\[\e[1;35m\]\h:\w\$\[\e[0;31m\] '
#export PS1='\[\e[1;35m\]\u@\[\e[m\]\[\e[1;35m\]\H\[\e[m\] \[\e[1;96m\]\w\[\e[m\] \[\e[1;32m\]\$\[\e[m\] \[\e[1;37m\] '
#fi
...
#else
#  PS1='\[\e[1;35m\]\u@\[\e[m\]\[\e[1;35m\]\H\[\e[m\] \[\e[1;96m\]\w\[\e[m\] \[\e[1;32m\]\$\[\e[m\] \[\e[1;37m\] '
#fi
