# Create links from images, create thumbnails x200 from images
...
t="$b-thumb$oext"
convert +dither -thumbnail 'x200>' -colors 256 "$i"[1] $outdir/"$t"
...
echo '<img src="out/'$t'" height="200" width="'$w'" alt="'$b'"/></a>' #>>mkthumb.html
