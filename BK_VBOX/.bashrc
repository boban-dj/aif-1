...
################################################################################
## Monitor shit
alias monitor='xrandr --output DP-0 --auto --primary --output DVI-I-1 --auto --right-of DP-0'
...
## sed remove ~/ssh/.knownhost conflicting id
...
alias yt_movie="youtube-dl -o '%(title)s/%(title)s-%(id)s.%(ext)s'"
